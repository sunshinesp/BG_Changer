      ...
      >
        <div className="fixed flex flex-wrap justify-center bottom-12 inset-x-0 px-2">
          <div className="flex flex-wrap justify-center gap-3 shadow-lg bg-white px-3 py-2 rounded-3xl">
            ...
            <button onClick={() => setColor("hotpink")}className="outline-none px-4 py-1 rounded-full text-white shadow-sm"
            style={{backgroundColor: "hotpink"}}>
              Pink
            </button>

            <button onClick={() => setColor("grey")}className="outline-none px-4 py-1 rounded-full text-white shadow-sm"
